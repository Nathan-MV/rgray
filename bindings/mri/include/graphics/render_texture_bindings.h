...
template <class T> void free_render_texture(void* data) {
...
template <class T> VALUE alloc_render_texture(VALUE klass) { return Data_Wrap_Struct(klass, nullptr, free_render_texture<T>, new T()); }
